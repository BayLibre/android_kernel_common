...
<<<<<<< HEAD   (d2cab434b22cd0c26d4f34ab3cabfb2ab6a1c4a5 Revert "mm/hugetlb: fix two comments related to huge_pmd_uns)
	/*
	...
	if (force_flush)
		tlb_flush_mmu_tlbonly(tlb);
||||||| BASE   (fe9cf13cd2d24c720943e5d21b11a3b4b51957c8 mm/hugetlb: fix two comments related to huge_pmd_unshare())
	/*
...
=======
	huge_pmd_unshare_flush(tlb, vma);
>>>>>>> BRANCH (daa6707b71a2da23a82979fa21f788aeb706f1a2 mm/hugetlb: fix excessive IPI broadcasts when unsharing PMD )
}
