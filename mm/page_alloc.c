						...
						struct alloc_context *ac)
{
	...
	int reserve_flags;
	unsigned long vh_data;

	trace_android_vh_alloc_pages_slowpath_begin(gfp_mask, order, &vh_data);
	/*
...
got_pg:
	trace_android_vh_alloc_pages_slowpath_end(gfp_mask, order, &vh_data);
	return page;
}
