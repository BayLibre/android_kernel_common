...
/*
 * need these helpers to avoid including <trace/hooks/mm.h> into mm_inline.h
 */
void _trace_android_vh_add_page_to_lrulist(struct page *page, bool compound, enum lru_list lru)
{
    trace_android_vh_add_page_to_lrulist(page, compound, lru);
}
EXPORT_SYMBOL_GPL(_trace_android_vh_add_page_to_lrulist);

void _trace_android_vh_del_page_from_lrulist(struct page *page, bool compound, enum lru_list lru)
{
        trace_android_vh_del_page_from_lrulist(page, compound, lru);
}
EXPORT_SYMBOL_GPL(_trace_android_vh_del_page_from_lrulist);

/*
 * need this helper to avoid including <trace/hooks/mm.h> into rmap.h
 */
void _trace_android_vh_update_page_mapcount(struct page *page, bool inc_size, bool compound,
    bool *first_mapping, bool *success)
{
        trace_android_vh_update_page_mapcount(page, inc_size, compound, first_mapping, success);
}
EXPORT_SYMBOL_GPL(_trace_android_vh_update_page_mapcount);
