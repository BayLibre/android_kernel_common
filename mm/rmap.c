...
<<<<<<< HEAD   (b80fea5457ef7cbe2c1bc56d2cf0c068e56ad900 Merge 2eeca9383efe ("mm/hugetlb: fix two comments related to)
				if (!hugetlb_vma_trylock_write(vma))
					goto walk_abort;
				if (huge_pmd_unshare(mm, vma, address, pvmw.pte)) {
||||||| BASE   (2eeca9383efebb27c85a5ed12ba261c282f7a716 mm/hugetlb: fix two comments related to huge_pmd_unshare())
				if (!hugetlb_vma_trylock_write(vma)) {
					page_vma_mapped_walk_done(&pvmw);
					ret = false;
					break;
...
>>>>>>> BRANCH (ff37dd18ce7739a26aab0cc2d31006a45e6bde63 mm/hugetlb: fix excessive IPI broadcasts when unsharing PMD )
