...
keep:
		/*
		 * If there is an asynchronous hardware compression unit for zram,
		 * clearing the folio lock owner here might lag behind clearing
		 * the PG_locked. The main reason is to reduce code intrusion, but
