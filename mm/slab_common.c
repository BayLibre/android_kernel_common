...
#ifndef CONFIG_SLOB
static bool android_dyn_kmalloc_minalign_enabled;
...
static int __init setup_android_dyn_kmalloc_minalign(char *str)
{
	android_dyn_kmalloc_minalign_enabled = true;
	return 1;
}
__setup("android_dyn_kmalloc_minalign", setup_android_dyn_kmalloc_minalign);

void __init init_kmalloc_cache_parameters(void)
{
	if (android_dyn_kmalloc_minalign_enabled &&
