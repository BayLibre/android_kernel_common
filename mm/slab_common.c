...
#ifndef CONFIG_SLOB
static int __init setup_kmalloc_64_create(char *str)
{
	if (IS_ALIGNED(64, cache_line_size()))
		__kmalloc_64_create = true;

	return 1;
}
__setup("__kmalloc_64_create", setup_kmalloc_64_create);
		...
		unsigned int useroffset, unsigned int usersize)
{
	 ...
	 */
	if (__kmalloc_64_create && size == 64)
		align = 64;
...
bool __kmalloc_64_create __ro_after_init;
EXPORT_SYMBOL_GPL(__kmalloc_64_create);
