...
<<<<<<< HEAD   (bdb26509a24b41a5b4e632a4b34c1aeff7a00e05 Merge 9fcedabaae00 ("xfrm: xfrm_alloc_spi shouldn't use 0 as)
	if (lru_gen_enabled() && lru_gen_clear_refs(folio))
		return;

	folio_batch_add_and_move(folio, lru_deactivate_file, true);
||||||| BASE   (9fcedabaae0096f712bbb4ccca6a8538af1cd1c8 xfrm: xfrm_alloc_spi shouldn't use 0 as SPI)
	folio_batch_add_and_move(folio, lru_deactivate_file, true);
=======
	folio_batch_add_and_move(folio, lru_deactivate_file);
>>>>>>> BRANCH (17195a7d754a5c6a31888702ca93f6f08f3383ad iommufd: Fix race during abort for file descriptors)
}
