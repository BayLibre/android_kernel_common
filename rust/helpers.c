...
unsigned int rust_shrink_free_page(struct list_head *item, struct list_lru_one *list, spinlock_t *lock, void *cb_arg);

enum lru_status rust_helper_rust_shrink_free_page_wrap(struct list_head *item, struct list_lru_one *list, spinlock_t *lock, void *cb_arg) {
