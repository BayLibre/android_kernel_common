...
<<<<<<< HEAD   (7f6f0e358965d6a8c169dfad6b10e096f1f228ae Merge 952596b08c74 ("mm/hugetlb: fix huge_pmd_unshare() vs G)
...
=======
	...
	if (!ptr) {
		ptr = kvmalloc_array(nblocks, locksz, GFP_KERNEL);
		if (!ptr)
>>>>>>> BRANCH (ecbc622e0f5202e17a2f13dadb0900273faee0eb Linux 5.10.239)
			return -ENOMEM;
