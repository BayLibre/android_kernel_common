...
<<<<<<< TARGET BRANCH (1c0089 ANDROID: GKI: vivo add symbols to symbol list am: c3c127d9ac)
	if (offset >= 0) {
...
=======
	...
	if (offset == INT_MIN)
		return -EFAULT;
>>>>>>> SOURCE BRANCH (9ffdb9 UPSTREAM: bpf: support SKF_NET_OFF and SKF_LL_OFF on skb fra)
