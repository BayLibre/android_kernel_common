			       ...
			       unsigned int *size)
{
	...
	void (*compat_from_user)(void *, const void *) = get_xt_match_compat_from_user(match);
...
{
	const struct xt_match *match = m->u.kernel.match;
	int (*compat_to_user)(void __user *, const void *) = get_xt_match_compat_to_user(match);
				...
				unsigned int *size)
{
	...
	void (*compat_from_user)(void *, const void *) = get_xt_target_compat_from_user(target);
...
{
	const struct xt_target *target = t->u.kernel.target;
	int (*compat_to_user)(void __user *, const void *) = get_xt_target_compat_to_user(target);
