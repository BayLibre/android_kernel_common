...
/*
 * trace_android_vh_record_lock_starttime  is called in
 * include/linux/percpu-rwsem.h by including include/hooks/dtask.h, which
 * will result to build-err. So we create
 * func:_trace_android_vh_record_lock_starttime for percpu-rwsem.h to call.
 */
void _trace_android_vh_record_lock_starttime(struct task_struct *tsk,
