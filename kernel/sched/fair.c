...
{
<<<<<<< HEAD   (c7f0d14da3b1862a69482cccf8e1ddccc6e1bbc1 Merge 028084eca169 ("sched/fair: Rename cfs_rq::avg_vruntime)
...
||||||| BASE   (028084eca16915b66946671219810f538d269309 sched/fair: Rename cfs_rq::avg_vruntime to ::sum_w_vruntime,)
	if ((s64)(se->vruntime - se->deadline) < 0)
=======
	if (vruntime_cmp(se->vruntime, "<", se->deadline))
>>>>>>> BRANCH (423b750d87d2e162139c53be709a60a59829f928 sched/fair: Introduce and use the vruntime_cmp() and vruntim)
		return false;
