...
<<<<<<< HEAD   (9eb7168d21babd324453313c48c26bf6a5ce7b2d ANDROID: {gki,microdroid}_defconfig: drop removed POLYVAL op)
			if (rq->donor->sched_class == &ext_sched_class)
				rq->donor->scx.slice = 0;
||||||| BASE   (d905362ff5b86f6b619953ada8e0af84158db2e9 Linux 6.18.8)
			if (rq->curr->sched_class == &ext_sched_class)
				rq->curr->scx.slice = 0;
=======
			if (cur_class == &ext_sched_class)
				rq->curr->scx.slice = 0;
>>>>>>> BRANCH (adb851edb70783e3ded28044491f5a3ed065b7b2 Linux 6.18.9)
