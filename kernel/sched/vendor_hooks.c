...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_fix_prev_keep_slice);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_scx_ops_enable_state);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_scx_enabled);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_set_cpus_allowed_scx);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_task_switch_finish);
