...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sped_add_task);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sped_chk_task);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sped_del_task);
