...
Start_fs_sync:
	...
	/*
	 * If a suspend immediately follows a previous suspend that was aborted
	 * during fs_sync, start the fs_sync of the subsequent suspend only when
	 * the previous fs_sync has finished.
	 */
