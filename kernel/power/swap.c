...
int hib_write_data_to_swap(void *buf, sector_t offset, void *hb)
{
	return write_page(buf, offset, (struct hib_bio_batch *)hb);
}
EXPORT_SYMBOL_GPL(hib_write_data_to_swap);
