...
<<<<<<< HEAD   (f17c293bc1d3c412243c581743ca6fa4a9432f2b Merge ee2fe81cdcd1 ("Merge tag 'docs-6.18' of git://git.lwn.)
		    !(gfp & (GFP_DMA32 | GFP_DMA)) &&
		    !zone_dma32_are_empty()) {
||||||| BASE   (ee2fe81cdcd17f875aeca074afe64d7e8f57750f Merge tag 'docs-6.18' of git://git.lwn.net/linux)
		    !(gfp & (GFP_DMA32 | GFP_DMA))) {
=======
		    !(gfp & (GFP_DMA32 | GFP_DMA)))
>>>>>>> BRANCH (a498d59c469bf1cab2710ffeb34050f475de28ce Merge tag 'dma-mapping-6.18-2025-09-30' of git://git.kernel.)
			gfp |= GFP_DMA32;
