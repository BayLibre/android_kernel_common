...
/**
 * gunyah_hypercall_addrspace_modify_pages() - Perform operations on an address space
 * @capid: capability ID of the address space
 * @addr: Base address in the address space
 * @size: size
 * @flags: Modify flags
 */
