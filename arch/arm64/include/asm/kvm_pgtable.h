...
/**
 * kvm_pgtable_stage2_reclaim_leafs() - Attempt to reclaim leaf page-table pages
 *					by coalescing table entries into block
 *					mappings..
 * @pgt:	Page-table structure initialised by kvm_pgtable_stage2_init*().
 * @addr:	Intermediate physical address from which to reclaim leafs,
