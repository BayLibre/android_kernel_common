...
HYP_EVENT(ffa_call,
	HE_PROTO(u64 func_id, u64 res_a0, u64 res_a1, u64 res_a2, u64 res_a3, int handled, int err),
	HE_STRUCT(
	...
	HE_PRINTK("ffa_func=0x%llx a0=0x%llx a1=0x%llx a2=0x%llx a3=%llx handled=%d err=%d",
		  __entry->func_id, __entry->res_a0, __entry->res_a1,
		  __entry->res_a2, __entry->res_a3, __entry->handled, __entry->err)
);
#endif
