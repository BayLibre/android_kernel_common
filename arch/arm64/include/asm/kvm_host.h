...
#define _vcpu_sve_max_vq(sve_max_vl)	sve_vq_from_vl(sve_max_vl)
...
#define _vcpu_sve_state_size(sve_max_vl) ({				\
	...
	if (WARN_ON(!sve_vl_valid(sve_max_vl))) {			\
		...
		__vcpu_vq = _vcpu_sve_max_vq(sve_max_vl);		\
...
#define vcpu_sve_max_vq(vcpu)	_vcpu_sve_max_vq((vcpu)->arch.sve_max_vl)
