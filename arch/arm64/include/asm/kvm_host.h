...
#define KVM_ARCH_FLAG_MMIO_GUARD			11
	unsigned long flags;
...
#define KVM_HYP_REQ_SMCCC_ARG_SIZE_MAX (sizeof(struct arm_smccc_res) - offsetof(struct arm_smccc_res, a2) - 1)
...
static inline void
hyp_req_to_smccc(struct kvm_cpu_context *host_ctxt, struct kvm_hyp_req *req)
{
