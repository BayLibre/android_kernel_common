...
#define V9_READ_MPTC_TAG_PPN_MASK	(V9_READ_MPTC_TAG_PPN_VALID_MASK | V9_READ_MPTC_TAG_PPN_TPN_PPN_MASK)

#define V9_READ_MPTC_TAG_OTHERS_VID_MASK	GENMASK(10, 8)
#define V9_READ_MPTC_TAG_OTHERS_PAGE_GRANULE_MASK GENMASK(5, 4)
#define V9_READ_MPTC_TAG_OTHERS_MASK (V9_READ_MPTC_TAG_OTHERS_VID_MASK | V9_READ_MPTC_TAG_OTHERS_PAGE_GRANULE_MASK)
...
#define V9_READ_PTLB_MASK	(V9_READ_PTLB_WAY_MASK | V9_READ_PTLB_SET_MASK |  V9_READ_PTLB_PTLB_MASK | V9_READ_PTLB_PMMU_MASK)
...
#define V9_READ_PTLB_TAG_MASK	(V9_READ_PTLB_TAG_VALID_MASK | V9_READ_PTLB_TAG_PAGE_SIZE_MASK | V9_READ_PTLB_TAG_STAGE1_ENABLED_MASK | V9_READ_PTLB_TAG_VID_MASK | V9_READ_PTLB_TAG_TPN_MASK)
...
#define V9_READ_PTLB_DATA_S1_ENABLE_PPN_AP_MASK (V9_READ_PTLB_DATA_S1_ENABLE_PPN_AP_S2AP_MASK | V9_READ_PTLB_DATA_S1_ENABLE_PPN_AP_PPN_MASK)
...
#define V9_READ_PMMU_INFO_MASK (V9_READ_PMMU_INFO_NUM_PTLB | V9_READ_PMMU_INFO_VA_WIDTH | V9_READ_PMMU_INFO_NUM_STREAM_TABLE)

#define V9_READ_PMMU_PTLB_INFO_NUM_WAY	GENMASK(31, 16)
#define V9_READ_PMMU_PTLB_INFO_NUM_SET	GENMASK(15, 0)
#define V9_READ_PMMU_PTLB_INFO_MASK	 (V9_READ_PMMU_PTLB_INFO_NUM_WAY | V9_READ_PMMU_PTLB_INFO_NUM_SET)
...
#define V9_READ_PTLB(pmmu_index, ptlb_index, set, way) (V9_READ_PTLB_WAY(way) | V9_READ_PTLB_SET(set) | V9_READ_PTLB_PTLB(ptlb_index) | V9_READ_PTLB_PMMU(pmmu_index))
...
#define V9_READ_STLB_MASK_TYPEA   (V9_READ_STLB_SET_MASK_TYPEA | V9_READ_STLB_WAY_MASK_TYPEA | V9_READ_STLB_SUBLINE_MASK_TYPEA  | V9_READ_STLB_STLBID_MASK_TYPEA)
...
#define V9_READ_STLB_MASK_TYPEB   (V9_READ_STLB_SET_MASK_TYPEB | V9_READ_STLB_WAY_MASK_TYPEB  | V9_READ_STLB_STLBID_MASK_TYPEB)
...
#define V9_READ_STLB_TPN_MASK    (V9_READ_STLB_TPN_TPN_MASK | V9_READ_STLB_TPN_S2VALID_MASK | V9_READ_STLB_TPN_STAGE1_ENABLED_MASK | V9_READ_STLB_TPN_VALID_MASK)

#define V9_READ_STLB_TAG_PPN_VALID_MASK_TYPEB	BIT(28)
#define V9_READ_STLB_TAG_PPN_PPN_MASK    GENMASK(23, 0)
#define V9_READ_STLB_TAG_PPN_MASK	(V9_READ_STLB_TAG_PPN_PPN_MASK | V9_READ_STLB_TAG_PPN_VALID_MASK_TYPEB)
...
#define V9_READ_STLB_TAG_OTHERS_MASK	(V9_READ_STLB_TAG_OTHERS_S2AP_MASK_TYPEA | V9_READ_STLB_TAG_OTHERS_PS_MASK | V9_READ_STLB_TAG_OTHERS_BPS_MASK | V9_READ_STLB_TAG_OTHERS_VID_MASK)
...
#define V9_READ_STLB_TYPEA(stlb_index, subline, set, way) (V9_READ_STLB_WAY_TYPEA(way) | V9_READ_STLB_SET_TYPEA(set) | V9_READ_STLB_STLBID_TYPEA(stlb_index) | V9_READ_STLB_SUBLINE_TYPEA(subline))
...
#define V9_READ_STLB_TYPEB(stlb_index,  set, way) (V9_READ_STLB_WAY_TYPEB(way) | V9_READ_STLB_SET_TYPEB(set) | V9_READ_STLB_STLBID_TYPEB(stlb_index))
