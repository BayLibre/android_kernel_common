				    ...
				    int uses_interp)
{
	...
	vdso_mapping_len = vdso_text_len + VVAR_NR_PAGES * MAX_PAGE_SIZE;
	...
	ret = _install_special_mapping(mm, vdso_base, VVAR_NR_PAGES * MAX_PAGE_SIZE,
	...
	vdso_base += VVAR_NR_PAGES * MAX_PAGE_SIZE;
