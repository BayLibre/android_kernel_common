...
void kvm_arm_vcpu_destroy(struct kvm_vcpu *vcpu)
{
	...
	if (sve_state && !WARN_ON_ONCE(kvm_vm_is_protected(vcpu->kvm))) {
		size_t reg_sz = PAGE_ALIGN(vcpu_sve_state_size(vcpu));
...
void kvm_reset_vcpu(struct kvm_vcpu *vcpu)
{
	 ...
	 */
<<<<<<< HEAD   (9b46cd7a6165159cf294bab4ae90fb62ea2fc7ce Revert "driver core: generalize driver_override in struct de)
	if (reset_state.reset)
		kvm_reset_vcpu_psci(vcpu, &reset_state);
||||||| BASE   (7c02a9bd7d14a89065fcf672b86d8e1d1a41d3b1 driver core: platform: use generic driver_override infrastru)
	if (reset_state.reset) {
...
>>>>>>> BRANCH (44c944a679974c2d18ee9b87070456d34193f3d4 Linux 6.18.21)
