 ...
 * reference count, all atomically.
 */
...
/*
 * Decrements the reference count for the vm atomically.
 */
static void shadow_vm_dec_ref(struct kvm_shadow_vm *vm)
{
	hyp_spin_lock(&shadow_table_lock);
