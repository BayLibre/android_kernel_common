...
int __pkvm_guest_share_hyp(struct pkvm_hyp_vcpu *vcpu, u64 ipa, u64 nr_pages, u64 *hyp_va)
{
	int ret;
	struct pkvm_hyp_vm *vm = pkvm_hyp_vcpu_to_hyp_vm(vcpu);
	kvm_pte_t pte;
...
int __pkvm_guest_unshare_hyp(struct pkvm_hyp_vcpu *vcpu, u64 ipa, u64 nr_pages)
{
	int ret;
	struct pkvm_hyp_vm *vm = pkvm_hyp_vcpu_to_hyp_vm(vcpu);
	kvm_pte_t pte;
