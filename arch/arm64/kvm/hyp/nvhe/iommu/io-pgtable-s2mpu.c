...
//to avoid making these unnecessary exter we add a macro
//to make only extern if compiling for EL1
//selftests are diabled by default
...
//allow EL1 to register multiple multiple versions at same runtime as this is used in self tests
#ifdef __KVM_NVHE_HYPERVISOR__
