...
static void handle___pkvm_notify_dying_guest_vm_avail(struct kvm_cpu_context *host_ctxt)
{
	DECLARE_REG(pkvm_handle_t, handle, host_ctxt, 1);

	__pkvm_notify_dying_guest_vm_avail(handle);
}
...
static const hcall_t host_hcall[] = {
	...
	HANDLE_FUNC(__pkvm_notify_dying_guest_vm_avail),
