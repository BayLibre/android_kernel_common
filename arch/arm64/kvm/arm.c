...
static void kvm_hyp_init_symbols(void)
{
	...
	kvm_nvhe_sym(id_aa64pfr0_override) = id_aa64pfr0_override;
	kvm_nvhe_sym(id_aa64pfr1_override) = id_aa64pfr1_override;
	kvm_nvhe_sym(id_aa64smfr0_override) = id_aa64smfr0_override;
