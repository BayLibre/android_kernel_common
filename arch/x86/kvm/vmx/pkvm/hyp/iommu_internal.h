...
unsigned long pkvm_iommu_cache_assign(struct pkvm_iommu *iommu, struct pkvm_iommu_domain *domain,
				      u16 did, u16 bdf, u8 ats_qdep,
				      ioasid_t pasid, enum cache_tag_type type);
void pkvm_iommu_cache_unassign(struct pkvm_iommu *iommu, struct pkvm_iommu_domain *domain,
			       u16 did, u16 bdf, ioasid_t pasid,
			       enum cache_tag_type type);
#else
