...
/**
 * __pkvm_host_share_hyp() - Share pages the host pages with hypervisor.
 *
 ...
 * @gpa + @size). The page state will be modified from PAGE_OWNED to
 * PAGE_SHARED_OWNED. And the host still can access these pages after that.
 *
...
/**
 * __pkvm_host_unshare_hyp() - Unshare host pages with hypervisor.
 *
 ...
 * @gpa + @size). The page state will be modified from PAGE_SHARED_OWNED to
 * PAGE_OWNED.
 *
 * Return: 0 on success, negative value on failure.
 */
