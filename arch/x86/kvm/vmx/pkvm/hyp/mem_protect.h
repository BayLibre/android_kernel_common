...
/**
 * __pkvm_host_donate_hyp_request_ro() - Donate host pages to pKVM hypervisor,
 * and request readonly access to the pages.
 *
 ...
 * @phys + @size). The host page state will be modified from PAGE_OWNED to
 * PAGE_SHARED_OWNED. The pages will be pinned so that host will not be able
 * to unshare the pages.
...
/**
 * __pkvm_hyp_release_host() - Release the pages donated by
 * __pkvm_host_donate_hyp_request_ro() back to the host.
 *
