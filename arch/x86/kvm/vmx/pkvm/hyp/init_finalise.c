...
static bool __pkvm_initialized = false;

static inline void set_pkvm_initialized(void)
{
	__pkvm_initialized = true;
}

bool pkvm_initialized(void)
{
	return __pkvm_initialized;
}
