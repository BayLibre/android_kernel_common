...
find_headers("include/uapi/linux/usbdevice_fs.h")
find_headers("include/uapi/linux/android/binder.h")
find_headers("include/uapi/linux/pci.h")
find_headers("include/uapi/linux/virtio_pci.h")
find_headers("include/uapi/linux/virtio_ring.h")
...
for h in headers:
    ...
    os.system(srctree+"/scripts/headers_install.sh %s %s" % (relpath2abspath(h),
