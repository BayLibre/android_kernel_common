...
struct lkl_host_operations {
	...
	void *(*kasan_init_shadow_memory)(void *, unsigned long);
	int (*kasan_release_shadow_memory)(void *, unsigned long);
	int (*kasan_map_shadow_memory)(void *, unsigned long);
	int (*kasan_map_thread_shadow_stack)(lkl_thread_t tid);
