...
__SYSCALL(__NR_virtio_mmio_device_remove, sys_virtio_mmio_device_remove)
__SYSCALL(__NR_lkl_pci_bus_add, sys_lkl_pci_bus_add)
__SYSCALL(__NR_lkl_pci_bus_remove, sys_lkl_pci_bus_remove)
