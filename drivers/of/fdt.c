...
<<<<<<< HEAD   (436052446c42ee0586b116692f3151bae5f7250b ANDROID: GKI: add unisoc modules symbols 2nd)
...
int __init early_init_dt_scan_chosen(char *cmdline)
{
	...
	if (p != NULL && l > 0) {
		if (concat_cmdline) {
			...
			strscpy(cmdline + cmdline_len, p,
				min((int)l, COMMAND_LINE_SIZE - cmdline_len));
		} else {
