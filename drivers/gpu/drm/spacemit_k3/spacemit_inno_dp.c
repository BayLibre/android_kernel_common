...
static int __init inno_dp_driver_init(void)
{
	return platform_driver_register(&inno_dp_driver);
}
module_init(inno_dp_driver_init);

static void __exit inno_dp_driver_exit(void)
{
	platform_driver_unregister(&inno_dp_driver);
}
module_exit(inno_dp_driver_exit);

MODULE_DESCRIPTION("Spacemit Innosilicon DP/eDP Driver");
MODULE_LICENSE("GPL");
