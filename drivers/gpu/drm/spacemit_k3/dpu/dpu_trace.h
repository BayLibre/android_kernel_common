...
#undef TRACE_SYSTEM
/*
 * Distinct trace system from the K1 spacemit-drm.ko (which uses "dpu" with
 * overlapping event names).  Both modules ship in the same image; without a
 * separate system the ftrace event registry would reject the K3 events on a
 * name conflict.
 */
#define TRACE_SYSTEM dpu_k3

#if !defined(_DPU_K3_TRACE_H_) || defined(TRACE_HEADER_MULTI_READ)
#define _DPU_K3_TRACE_H_
...
#define TRACE_INCLUDE_PATH ../../drivers/gpu/drm/spacemit_k3/dpu/
