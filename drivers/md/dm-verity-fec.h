...
struct dm_verity_fec {
	...
	bool sysfs_created; /*flag to check sysfs created once*/
};
...
extern void verity_fec_create_sysfs(struct dm_verity *v);
...
static inline void verity_fec_create_sysfs(struct dm_verity *v)
{
}
