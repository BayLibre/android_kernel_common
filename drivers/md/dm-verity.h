...
struct dm_verity_io {
	...
	/*
	 * True if verification is in a context where sleeping is ok.
	 * This is applicable to scenarios where some hashes are not in
	 * the cache and verification cannot block until they are read
	 * from disk. In such cases the value of this field is set to
	 * false and verification work will be deferred.
	 * */
	bool may_sleep;
	bool had_mismatch;

	struct work_struct work;
	struct work_struct inline_work;
