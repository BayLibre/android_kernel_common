...
impl MiscDevice for Ashmem {
    ...
    fn llseek(me: Pin<&Ashmem>, file: &mut File, offset: i64, whence: c_int) -> Result<isize> {
        let asma_file = {
    ...
    fn ioctl(me: Pin<&Ashmem>, _file: &File, cmd: u32, arg: usize) -> Result<isize> {
        ...
        match cmd {
            bindings::ASHMEM_SET_NAME => me.set_name(UserSlice::new(UserPtr::from_addr(arg), size).reader()),
            bindings::ASHMEM_GET_NAME => me.get_name(UserSlice::new(UserPtr::from_addr(arg), size).writer()),
            ...
            bindings::ASHMEM_GET_FILE_ID => me.get_file_id(UserSlice::new(UserPtr::from_addr(arg), size).writer()),
        ...
        bindings::ASHMEM_GET_NAME => {
            ...
            let full_name = unsafe {
                core::slice::from_raw_parts(
                    ...
                    (*dentry).__bindgen_anon_1.d_name.__bindgen_anon_1.__bindgen_anon_1.len as usize,
                )
            };
