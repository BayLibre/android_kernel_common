    ...
    fn translate_object(
        ...
        match object {
            ...
            BinderObjectRef::Ptr(obj) => {
                ...
                const BUFFER_FIELD_OFFSET: usize =
                    kernel::offset_of!(bindings::binder_buffer_object, buffer) as _;
                if let Err(err) =
                    view.write::<u64>(offset + BUFFER_FIELD_OFFSET, &buffer_ptr_in_user_space)
                {
