...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_dropbehind_enable);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_dropbehind_disable);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_dropbehind_invalidate);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_dropbehind_retrodrop);
