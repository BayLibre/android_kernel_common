...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_cma_set_owner);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_cma_clear_owner);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_cma_show_owner);
