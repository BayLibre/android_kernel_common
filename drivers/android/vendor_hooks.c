...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_record_lock_starttime);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_locktask_protect);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_locktask_tick_resched);
