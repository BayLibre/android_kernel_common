...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_clk_enable);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_clk_disable);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_clk_set_rate);
