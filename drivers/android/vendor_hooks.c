...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_rsem_wake);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_wsem_wake);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_rwsem_up_write);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_rwsem_downgrade_write);
