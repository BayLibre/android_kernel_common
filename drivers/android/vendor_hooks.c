...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_cleanup_policy);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_schedule_skip);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sugov_get_util);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_should_we_balance);
