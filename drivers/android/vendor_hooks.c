...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_oem_scheduler_tick);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_oem_free_task);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_oem_sched_fork);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_oem_enqueue_task);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_oem_dequeue_task);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_oem_select_task_rq_fair);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_oem_RB_enqueue_entity);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_oem_RB_dequeue_entity);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_oem_entity_tick);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_oem_enqueue_task_fair);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_oem_dequeue_task_fair);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_oem_check_preempt_tick);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_oem_check_preempt_wakeup);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_oem_pick_next_task_fair);
