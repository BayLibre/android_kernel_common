...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_mmc_protect);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_mmc_sd_cmdline_tuning);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_mmc_sd_dataline_tuning);
