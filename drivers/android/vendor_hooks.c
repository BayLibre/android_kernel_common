...
||||||| BASE   (6d7177caf93c82d75c9734b76a72234b3522d67b Revert "FROMLIST: scsi: ufs: core: Fix the code for entering)
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_do_el1_undef);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_try_fixup_sea);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_do_el1_bti);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_do_el1_fpac);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_oom_swapmem_gather_finish);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_file_open);
>>>>>>> CHANGE (9b44f2fb794ccd5a17777e317bec959558d21f9e ANDROID: vendor_hooks:add restricted hook for logbuf)
