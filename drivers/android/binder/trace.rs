...
declare_trace! {
    ...
    unsafe fn binder_transaction_thread_selected(t: rust_binder_transaction, th: rust_binder_thread);
    ...
    unsafe fn binder_transaction_alloc_buf(debug_id: c_int, data: *const binder_transaction_data_sg);
