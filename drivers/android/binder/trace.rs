...
declare_trace! {
    ...
    fn rust_binder_update_page_range(pid: c_int, allocate: bool, start: usize, end: usize);
    fn rust_binder_alloc_lru_start(pid: c_int, page_index: usize);
    fn rust_binder_alloc_lru_end(pid: c_int, page_index: usize);
    fn rust_binder_free_lru_start(pid: c_int, page_index: usize);
    fn rust_binder_free_lru_end(pid: c_int, page_index: usize);
    fn rust_binder_alloc_page_start(pid: c_int, page_index: usize);
    fn rust_binder_alloc_page_end(pid: c_int, page_index: usize);
    fn rust_binder_unmap_user_start(pid: c_int, page_index: usize);
