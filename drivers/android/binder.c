...
static int binder_open(struct inode *nodp, struct file *filp)
{
	...
	trace_android_vh_binder_data_preset(&binder_procs, &binder_procs_lock, &binder_transaction_log,
		&binder_transaction_log_failed, sizeof(struct binder_transaction_log));
	mutex_lock(&binder_procs_lock);
