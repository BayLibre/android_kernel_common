...
use {context::Context, process::Process, thread::Thread, transaction::Transaction};
...
impl kernel::Module for BinderModule {
    fn init(_module: &'static kernel::ThisModule) -> Result<Self> {
        ...
        let ctx = Context::new(kernel::c_str!("rust_binder"))?;
        let reg = Registration::new_pinned(format_args!("rust_binder"), ctx)?;
