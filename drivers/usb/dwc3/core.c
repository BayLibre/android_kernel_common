...
static void dwc3_set_power_down_clk_scale(struct dwc3 *dwc)
{
	 ...
	 * rate of the suspend_clk.
	 *
	 * Only update the power down scale if the default is less than
	 * the calculated value from clk_get_rate() or if the default
	 * is questionably high (3x or more) to be within the requirement.
	 */
