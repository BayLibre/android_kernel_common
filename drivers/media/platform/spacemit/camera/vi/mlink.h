...
/* VI pipe reset stage definitions */
#define VI_PIPE_RESET_STAGE1		RESET_STAGE1
#define VI_PIPE_RESET_STAGE_CNT		3

/* Entity name length - may be defined in k1x_videodev2.h UAPI header */
#ifndef SPACEMIT_VI_ENTITY_NAME_LEN
