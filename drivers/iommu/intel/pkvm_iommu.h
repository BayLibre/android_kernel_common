...
int pkvm_domain_mapping(struct dmar_domain *domain, unsigned long iov_pfn,
			unsigned long phys_pfn, unsigned long nr_pages,
			int prot, int gfp);
int pkvm_domain_unmapping(struct dmar_domain *domain, unsigned long start_pfn,
...
static inline int pkvm_domain_mapping(struct dmar_domain *domain, unsigned long iov_pfn,
				      unsigned long phys_pfn, unsigned long nr_pages,
				      int prot, int gfp)
{
	return -EOPNOTSUPP;
}
static inline int pkvm_domain_unmapping(struct dmar_domain *domain, unsigned long start_pfn,
					unsigned long last_pfn)
{
	return -EOPNOTSUPP;
}
