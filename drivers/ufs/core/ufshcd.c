...
enum {
	dev_cmd_timeout_MIN     = 1,
	dev_cmd_timeout_DEFAULT = 1500,
	dev_cmd_timeout_MAX     = 30000
};
...
static unsigned int dev_cmd_timeout = dev_cmd_timeout_DEFAULT;

static int dev_cmd_timeout_set(const char *val, const struct kernel_param *kp)
{
	return param_set_uint_minmax(val, kp, dev_cmd_timeout_MIN,
				     dev_cmd_timeout_MAX);
}
