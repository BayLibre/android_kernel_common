...
static const struct ccu_reset_data k3_apmu_resets[] = {
	...
	[RESET_APMU_UCIE_IP]	= RESET_DATA(APMU_UCIE_CTRL,		0, BIT(1)),
	[RESET_APMU_UCIE_HOT]	= RESET_DATA(APMU_UCIE_CTRL,		0, BIT(2)),
	[RESET_APMU_UCIE_MON]	= RESET_DATA(APMU_UCIE_CTRL,		0, BIT(3)),
