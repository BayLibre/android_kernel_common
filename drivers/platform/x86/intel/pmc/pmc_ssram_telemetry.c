...
#define PCI_DEVICE_ID_INTEL_PMC_PTL_PCDH        0xe37f
#define PCI_DEVICE_ID_INTEL_PMC_PTL_PCDP        0xe47f
static const struct pci_device_id intel_pmc_ssram_telemetry_pci_ids[] = {
	...
	{ PCI_DEVICE(PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_PMC_PTL_PCDH) },
	{ PCI_DEVICE(PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_PMC_PTL_PCDP) },
	{ }
};
