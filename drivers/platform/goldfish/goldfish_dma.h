...
struct goldfish_dma_context {
	...
	atomic_t in_use;		/* marks whether the region is currently
					 * in use (unrelated to |mutex_lock|)
					 */
...
#define GOLDFISH_DMA_REGION_AVAILABLE (0)
#define GOLDFISH_DMA_REGION_USED (1)
