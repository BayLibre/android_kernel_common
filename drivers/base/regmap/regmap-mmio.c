...
static int regmap_mmio_write(void *context, unsigned int reg, unsigned int val)
{
	...
	trace_android_vh_regmap_mmio_write_entry(ctx, reg, val, &tmp_data);
	ctx->reg_write(ctx, reg, val);
	trace_android_vh_regmap_mmio_write_exit(ctx, reg, val, &tmp_data);
...
static int regmap_mmio_read(void *context, unsigned int reg, unsigned int *val)
{
	...
	trace_android_vh_regmap_mmio_read_entry(ctx, reg, *val, &tmp_data);
	*val = ctx->reg_read(ctx, reg);
	trace_android_vh_regmap_mmio_read_exit(ctx, reg, *val,  &tmp_data);
