...
/**
 * trusty_logbuffer_register() - Registers a new log buffer as a misc device
 *
 ...
 * @show:   callback function implemented by trusty_log_logbuffer_register's
 *          client. This callback is invoked when the seq_file's show function
 *          is invoked
 *
 * Return:
...
/**
 * trusty_logbuffer_unregister() - Unregisters a log buffer
