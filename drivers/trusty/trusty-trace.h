...
DECLARE_EVENT_CLASS(trusty_smc4_class,
	...
	TP_printk("0x%x 0x%x 0x%x 0x%x", __entry->r0, __entry->r1, __entry->r2,
		  __entry->r3)
);
...
DEFINE_TRUSTY_SMC4_EVENT(trusty_fast_call32);
DEFINE_TRUSTY_SMC4_EVENT(trusty_fast_call64);
DEFINE_TRUSTY_SMC4_EVENT(trusty_std_call_smc);
...
DEFINE_TRUSTY_SMC_RETURN_EVENT(trusty_fast_call32_done);
DEFINE_TRUSTY_SMC_RETURN_EVENT(trusty_fast_call64_done);
DEFINE_TRUSTY_SMC_RETURN_EVENT(trusty_std_call_smc_done);
