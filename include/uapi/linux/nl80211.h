 ...
 *	of LTFs is (number of LTF repetitions) * (number of space-time streams).
 *	This limits the allowed combinations of LTF repetitions and STS.
 * @NL80211_PMSR_FTM_CAPA_ATTR_RSTA_EDCA_SUPPORT: flag attribute indicating the
 *	device supports operating as the RSTA in PMSR FTM request for EDCA-based
 *	ranging
 * @NL80211_PMSR_FTM_CAPA_ATTR_RSTA_NTB_SUPPORT: flag attribute indicating the
 *	device supports operating as the RSTA in PMSR FTM request for NTB-based
 *	ranging
...
enum nl80211_peer_measurement_ftm_capa {
	...
	NL80211_PMSR_FTM_CAPA_ATTR_RSTA_EDCA_SUPPORT,
	NL80211_PMSR_FTM_CAPA_ATTR_RSTA_NTB_SUPPORT,
