...
/**
 * would_exceed_max_nr_vmas - check if a VMA operation would exceed max_map_count
 ...
 */
extern bool would_exceed_max_nr_vmas(struct mm_struct *mm,
					    unsigned int new_vmas);
