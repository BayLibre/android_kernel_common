...
#define ISOLATED_FOLIO_MIN ((int) MAX_NR_GENS)
#define ISOLATED_FOLIO_MAX ((int) (MAX_NR_GENS + 2))
...
void lruvec_del_folio(struct lruvec *lruvec, struct folio *folio)
{
	...
	if (lru_gen_del_folio(lruvec, folio, false, false))
		return;
