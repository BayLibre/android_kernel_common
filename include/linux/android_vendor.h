...
#define android_init_vendor_data(p, n) memset(&p->android_vendor_data##n, 0, sizeof(p->android_vendor_data##n))
#define android_init_oem_data(p, n) memset(&p->android_oem_data##n, 0, sizeof(p->android_oem_data##n))
#else
