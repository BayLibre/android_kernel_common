...
typedef int (*process_module_fn_t)(const char *mod_name, void *mod_addr, void *data);
...
/* android_debug_for_each_module will preempt_disable */
...
static inline void android_debug_for_each_module(process_module_fn_t fn, void *data) {}
