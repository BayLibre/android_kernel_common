...
#define ARM_SMCCC_KVM_FUNC_MEM_RELINQUISH	5
#define ARM_SMCCC_KVM_FUNC_MMIO_GUARD_INFO	6
#define ARM_SMCCC_KVM_FUNC_MMIO_GUARD_ENROLL	7
#define ARM_SMCCC_KVM_FUNC_MMIO_GUARD_MAP	8
#define ARM_SMCCC_KVM_FUNC_MMIO_GUARD_UNMAP	9
