...
#define ARM_SMCCC_KVM_FUNC_GET_CPUFREQ		2
#define ARM_SMCCC_KVM_FUNC_UCLAMP		3
#define ARM_SMCCC_KVM_FUNC_GET_CPUFREQ_TBL	4
...
#define ARM_SMCCC_VENDOR_HYP_KVM_GET_CPUFREQ_FUNC_ID			\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_32,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP,			\
			   ARM_SMCCC_KVM_FUNC_GET_CPUFREQ)
...
/*
 * uclamp sync service is a fieature used for sync the guest task's uclamp
