...
#define kmalloc_node_trace(_s, _flags, _node, _size)		\
	kmalloc_hooks(_kmalloc_node_trace(_s, _flags, _node, _size))
...
#define kmalloc_track_caller(size, flags) \
	kmalloc_hooks(__kmalloc_node_track_caller(size, flags, \
