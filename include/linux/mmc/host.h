...
struct mmc_cqe_ops {
	...
	/*
	 *Update the request queue with keyslot manager details.
	 *This keyslot manager will be used by block crypto to configure the
	 *crypto engine for data encryption.
	 */
