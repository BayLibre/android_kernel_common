...
TRACE_EVENT(cpu_idle_predicted_sleep_length,
	...
	TP_PROTO(unsigned int cpu_id, unsigned long predicted_sleep_length_ns),

	TP_ARGS(cpu_id, predicted_sleep_length_ns),
	...
	TP_printk("cpu=%lu predicted_sleep_length_ns=%lu",
		__entry->cpu_id, __entry->predicted_sleep_length_ns)
);
