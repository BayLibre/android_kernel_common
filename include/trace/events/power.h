...
TRACE_EVENT(cpu_idle_predicted_sleep_length,
	...
	TP_ARGS(cpu_id, state, predicted_sleep_length_ns),
	...
	TP_printk("cpu=%lu state=%lu predicted_sleep_length_ns=%lu",
		__entry->cpu_id, __entry->state, __entry->predicted_sleep_length_ns)
);
