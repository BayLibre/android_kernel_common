...
=======
<<<<<<< HEAD   (15e99e FROMGIT: usb: dwc3: gadget: Refactor EP0 forced stall/restar)
=======
DECLARE_RESTRICTED_HOOK(android_rvh_binder_transaction,
	TP_PROTO(struct binder_proc *target_proc, struct binder_proc *proc,
		struct binder_thread *thread, struct binder_transaction_data *tr),
...
>>>>>>> CHANGE (254fb1 ANDROID: Add vendor hooks for binder perf tuning)
>>>>>>> CHANGE (626066 ANDROID: Add vendor hooks for binder perf tuning)
