...
#define trace_android_vh_futex_sleep_start(p)
#define trace_android_vh_do_futex(cmd, flags, uaddr2)
#define trace_android_vh_futex_wait_start(flags, bitset)
#define trace_android_vh_futex_wait_end(flags, bitset)
#define trace_android_vh_futex_wake_traverse_plist(chain, target_nr, key, bitset)
#define trace_android_vh_futex_wake_this(ret, nr_wake, target_nr, p)
#define trace_android_vh_futex_wake_up_q_finish(nr_wake, target_nr)
#endif
