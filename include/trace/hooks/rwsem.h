...
DECLARE_HOOK(android_vh_rwsem_init,
	...
	TP_ARGS(sem));
DECLARE_HOOK(android_vh_rsem_wake,
	TP_PROTO(struct rw_semaphore *sem),
	TP_ARGS(sem));
DECLARE_HOOK(android_vh_wsem_wake,
	TP_PROTO(struct rw_semaphore *sem),
	TP_ARGS(sem));
DECLARE_HOOK(android_vh_rwsem_up_write,
	TP_PROTO(struct rw_semaphore *sem),
	TP_ARGS(sem));
DECLARE_HOOK(android_vh_rwsem_downgrade_write,
	TP_PROTO(struct rw_semaphore *sem),
	TP_ARGS(sem));
...
#define trace_android_vh_rsem_wake(sem)
#define trace_android_vh_wsem_wake(sem)
#define trace_android_vh_rwsem_up_write(sem)
#define trace_android_vh_rwsem_downgrade_write(sem)
