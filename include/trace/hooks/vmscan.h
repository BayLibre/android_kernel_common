...
DECLARE_HOOK(android_vh_shrink_slab_async,
	TP_PROTO(struct shrink_control *shrinkctl, struct shrinker *shrinker, long freeable,
	        bool *do_sync, int priority),
	TP_ARGS(shrinkctl, shrinker, freeable, do_sync, priority));
