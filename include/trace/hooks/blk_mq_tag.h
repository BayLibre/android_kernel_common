...
#undef TRACE_SYSTEM
#define TRACE_SYSTEM blk_mq_tag

#define TRACE_INCLUDE_PATH trace/hooks

#if !defined(_TRACE_HOOK_BLK_MQ_TAG_H) || defined(TRACE_HEADER_MULTI_READ)
#define _TRACE_HOOK_BLK_MQ_TAG_H
...
#endif /* _TRACE_HOOK_BLK_MQ_TAG_H */
