...
*/
<<<<<<< HEAD   (78728ec45ac394b55ff757e21912c8de4c56ca08 ANDROID: GKI: Add QCOM symbols for scheduling)
||||||| BASE   (4b7014400eefe60eed5cc332d59617b3a0079ea9 ANDROID: ufs: add vendor hooks in the ufs command processing)
struct mem_cgroup;
...
DECLARE_HOOK(android_vh_show_smap,
	TP_PROTO(struct seq_file *m,
		...
		unsigned long same, unsigned long huge),
	TP_ARGS(m, swap_shared, writeback, same, huge));
>>>>>>> CHANGE (fca767b30e2d1fb97bf7a2b2d26f2e21f598cfea ANDROID: mm: add a hook to customize zone watermark breach d)
