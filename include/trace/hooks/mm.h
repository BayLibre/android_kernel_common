...
||||||| BASE   (c589e36ae9009886a2dec9689f73cdb28b523835 FROMGIT: rust: fixup MODVERSIONS series)
struct mem_cgroup;
...
DECLARE_RESTRICTED_HOOK(android_rvh_vfree_bypass,
	TP_PROTO(const void *addr, bool *bypass),
	TP_ARGS(addr, bypass), 1);
>>>>>>> CHANGE (3d19b0b8ad1a3afbd7ee65ccdfaf89bec3c67989 ANDROID: vendor_hooks: add hook to perform targeted memory m)
