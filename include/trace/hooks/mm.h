...
||||||| BASE   (0457ed368ff5cff62d51b049f480f20a89c247e5 ANDROID: mm: add vendor hook to bypass migration target)
struct mem_cgroup;
...
DECLARE_HOOK(android_vh_show_smap,
	TP_PROTO(struct seq_file *m,
		...
		unsigned long same, unsigned long huge),
	TP_ARGS(m, swap_shared, writeback, same, huge));
>>>>>>> CHANGE (4e4cbc1f28feb272a1137668809df41a8e85a7a4 ANDROID: vendor_hooks: add hooks for extra memory)
