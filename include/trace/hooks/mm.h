...
||||||| BASE   (c16ea53e9a92da7e14eabe8a7e1d161756f04a11 FROMLIST: ALSA: usb-audio: Introduce USB SND platform op cal)
struct mem_cgroup;
...
DECLARE_HOOK(android_vh_show_smap,
	TP_PROTO(struct seq_file *m,
		...
		unsigned long same, unsigned long huge),
	TP_ARGS(m, swap_shared, writeback, same, huge));
>>>>>>> CHANGE (0457ed368ff5cff62d51b049f480f20a89c247e5 ANDROID: mm: add vendor hook to bypass migration target)
