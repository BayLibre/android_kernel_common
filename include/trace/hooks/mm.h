...
||||||| BASE   (c9bbf5834a77bfd1089db26a1f581b8de26f2236 ANDROID: mm: add vendor hook to skip memcg reclaim by priori)
struct mem_cgroup;
...
DECLARE_HOOK(android_vh_cma_alloc_retry,
	TP_PROTO(char *name, int *retry),
	TP_ARGS(name, retry));
>>>>>>> CHANGE (7207203cc3d27a8f6d87de3e12c9a41833e2030d ANDROID: vendor_hooks: vendor hook for MM)
