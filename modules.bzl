...
_X86_64_GKI_MODULES_LIST = [
    # keep sorted
<<<<<<< TARGET BRANCH (99a38ec6eb22c581ea6cc00a1b17ea914db8ea3c UPSTREAM: vsock: Do not allow binding to VMADDR_PORT_ANY am:)
    "drivers/acpi/fan.ko",
...
=======
    "drivers/android/binder/rust_binder.ko",
>>>>>>> SOURCE BRANCH (079b8b87bb24d73fdfb04d22b8badda368101464 ANDROID: rust_binder: use dedicated build files)
    "drivers/ptp/ptp_kvm.ko",
