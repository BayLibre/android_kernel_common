...
def _get_kunit_modules_list_minus_select(arch, map_each):
    ...
    if arch == "arm":
        ...
        kunit_modules_list.append("drivers/clk/clk_kunit_helpers.ko")
<<<<<<< HEAD   (c11cf0c8d61b5feab80a18340bd3d474de360ef0 ANDROID: Clarify cherry-pick policy am: dc7d826e57)
    elif arch == "riscv64":
        kunit_modules_list += []
    else:
        fail("{}: arch {} not supported. Use one of [arm, arm64, i386, x86_64, riscv64]".format(
...
=======
>>>>>>> BRANCH (8a37f56281ae147384b2ac57c01524f71025c4e5 ANDROID: kleaf: add modules_superset to modules.bzl.)
