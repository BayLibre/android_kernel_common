...
int incfs_ioctl_verity_get_flags(struct file *f, void __user *arg);
...
static inline int incfs_ioctl_verity_get_flags(struct file *f, void __user *arg)
{
	return -EOPNOTSUPP;
}

static inline int incfs_ioctl_verity_measure(struct file *filp,
					     void __user *_uarg)
{
	return -EOPNOTSUPP;
}
