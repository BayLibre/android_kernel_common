		       ...
		       unsigned int open_flags, fl_owner_t id, bool isdir)
{
	 ...
	 */
<<<<<<< HEAD   (d8c3891a81a56312fdd2a7540a06b1ecb86b0048 Merge c7ec75f3cbf7 ("fuse: allocate ff->release_args only if)
	fuse_file_put(ra->inode, ff, ff->fm->fc->destroy, isdir);
||||||| BASE   (c7ec75f3cbf73bd46f479f7d6942585f765715da fuse: allocate ff->release_args only if release is needed)
	fuse_file_put(ff, ff->fm->fc->destroy);
=======
	fuse_file_put(ff, false);
>>>>>>> BRANCH (bfd17b6138df0122a95989457d8e18ce0b86165e fuse: fix livelock in synchronous file put from fuseblk work)
}
