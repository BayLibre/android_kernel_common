...
EXPORT_SYMBOL_NS(inc_nlink, ANDROID_GKI_VFS_EXPORT_ONLY);
...
EXPORT_SYMBOL_NS(igrab, ANDROID_GKI_VFS_EXPORT_ONLY);
...
EXPORT_SYMBOL_NS(file_update_time, ANDROID_GKI_VFS_EXPORT_ONLY);
