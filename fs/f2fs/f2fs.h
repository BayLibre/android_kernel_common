...
enum {
	...
	SBI_LOOKUP_MODE_BIT0,
	SBI_LOOKUP_MODE_BIT1,
	MAX_SBI_FLAG,
};
...
{
	if (is_sbi_flag_set(sbi, SBI_LOOKUP_MODE_BIT1))
		return LOOKUP_AUTO;
	if (is_sbi_flag_set(sbi, SBI_LOOKUP_MODE_BIT0))
...
{
	clear_sbi_flag(sbi, SBI_LOOKUP_MODE_BIT0);
	clear_sbi_flag(sbi, SBI_LOOKUP_MODE_BIT1);

	if (mode == LOOKUP_COMPAT)
		set_sbi_flag(sbi, SBI_LOOKUP_MODE_BIT0);
	else if (mode == LOOKUP_AUTO)
		set_sbi_flag(sbi, SBI_LOOKUP_MODE_BIT1);
}
