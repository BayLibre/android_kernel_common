					    ...
					    struct sof_ipc4_timestamp_info *time_info)
{
	...
	if (host_copier->data.gtw_cfg.node_id == SOF_IPC4_INVALID_NODE_ID) {
		...
		/*
<<<<<<< HEAD   (40435e5332925bf7429f8e4c796040981fcc4968 ANDROID: GKI: explain ANDROID_KABI_TYPE_STRING usage am: c19)
...
>>>>>>> BRANCH (fe486d3412a36e74e999e3c84ffd43edcfc1db0c Merge tag 'android16-6.12.58_r00' into android16-6.12)
		goto out;
	}
