...
int main(int argc, char *argv[])
{
	...
	/*
	 * Create pKVM protected VMs, as KVM_IRQFD requires an in-kernel IRQ chip.
	 * Also create an unused vCPU as certain architectures need to complete IRQ
	 * chip initialization after all possible vCPUs for a VM have been created.
	 */
	vm1 = vm_create_shape_with_one_vcpu(VM_SHAPE_PKVM_PROTECTED, &unused, NULL);
	vm2 = vm_create_shape_with_one_vcpu(VM_SHAPE_PKVM_PROTECTED, &unused, NULL);
