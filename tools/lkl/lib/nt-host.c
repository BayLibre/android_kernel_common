...
static void *asan_kasan_shadow_memory(void *addr, unsigned long size)
{
	// TODO: implement this routine for NT hosts
	return NULL;
}

static int kasan_release_shadow_memory(void *addr, unsigned long size)
{
	// TODO: implement this routine for NT hosts
	return -1;
}

static int kasan_map_shadow_memory(void *addr, unsigned long size)
{
	// TODO: implement this routine for NT hosts
	return -1;
}

static int kasan_map_thread_shadow_stack(lkl_thread_t thread)
{
	// TODO: implement this routine for NT hosts
	return -1;
}
...
#ifdef LKL_CONFIG_KASAN
	if (kasan_map_thread_shadow_stack(GetThreadId(h)) != 0)
		return 0;
#endif
...
struct lkl_host_operations lkl_host_ops = {
	...
	.mem_free = free,
#ifdef LKL_CONFIG_KASAN
	.kasan_init_shadow_memory = kasan_init_shadow_memory,
	.kasan_release_shadow_memory = kasan_release_shadow_memory,
	.kasan_map_shadow_memory = kasan_map_shadow_memory,
	.kasan_map_thread_shadow_stack = kasan_map_thread_shadow_stack,
#endif
	.ioremap = lkl_ioremap,
